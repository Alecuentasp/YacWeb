...
//ol.proj.get("EPSG:4326").setExtent([-80.729685, 20.716146, -76.687536, 23.994917]);
var wms_layers = [];
...
lyr_YACIMIENTOSMETALICOS_4.set('fieldAliases', {'idbal': 'idbal', 'YACIMIENTO': 'YACIMIENTO', 'SECTOR': 'SECTOR', 'TIPO': 'TIPO', 'MAT_PRIMA': 'MAT_PRIMA', 'EMPRESA': 'EMPRESA', 'ESTATUS': 'ESTATUS', 'extracc': 'extracc', 'extraccNat': 'extraccNat', 'UM': 'UM', 'umtext': 'umtext', 'parametros': 'parametros', 'parametr_1': 'parametr_1', 'Medidos': 'Medidos', 'Indicados': 'Indicados', 'Inferidos': 'Inferidos', 'REC_MED_IN': 'REC_MED_IN', 'Reservas_M': 'Reservas_M', 'C1_M_I': 'C1_M_I', 'C2_M_I': 'C2_M_I', 'C3_M_I': 'C3_M_I', 'C1_M': 'C1_M', 'C2_M': 'C2_M', 'C3_M': 'C3_M', 'C1_I': 'C1_I', 'C2_I': 'C2_I', 'C3_I': 'C3_I', 'C1_Inf': 'C1_Inf', 'C2_Inf': 'C2_Inf', 'C3_Inf': 'C3_Inf', 'C1_R_M_I': 'C1_R_M_I', 'C2_R_M_I': 'C2_R_M_I', 'C3_R_M_I': 'C3_R_M_I', 'X': 'X', 'Y': 'Y', 'XNORTE': 'XNORTE', 'YNORTE': 'YNORTE', 'CONON': 'CONON', 'PROVINCIA': 'PROVINCIA', 'MUNICIPIO': 'MUNICIPIO', });
...
lyr_YACIMIENTOSNOMETALICOS_3.set('fieldImages', {'idbal': '', 'YACIMIENTO': '', 'SECTOR': '', 'TIPO': '', 'MAT_PRIMA': '', 'EMPRESA': '', 'ESTATUS': '', 'extracc': '', 'extraccNat': '', 'UM': '', 'umtext': '', 'PAR_CALIDA': '', 'parametr_1': '', 'R_MEDIDOS': '', 'R_INDICADO': '', 'R_INFERIDO': '', 'REC_MED_IN': '', 'RESERVAS': '', 'C1_M_I': '', 'C2_M_I': '', 'C3_M_I': '', 'PAR_CAL1_M': '', 'PAR_CAL2_M': '', 'PAR_CAL3_M': '', 'PAR_CAL1_I': '', 'PAR_CAL2_I': '', 'PAR_CAL3_I': '', 'PAR_CAL1_1': '', 'PAR_CAL2_1': '', 'PAR_CAL3_1': '', 'C1_R_M_I': '', 'C2_R_M_I': '', 'C3_R_M_I': '', 'X': '', 'Y': '', 'XNORTE': '', 'YNORTE': '', 'CONON': '', 'PROVINCIA': '', 'MUNICIPIO': '', });
lyr_YACIMIENTOSMETALICOS_4.set('fieldImages', {'idbal': '', 'YACIMIENTO': '', 'SECTOR': '', 'TIPO': '', 'MAT_PRIMA': '', 'EMPRESA': '', 'ESTATUS': '', 'extracc': '', 'extraccNat': '', 'UM': '', 'umtext': '', 'parametros': '', 'parametr_1': '', 'Medidos': '', 'Indicados': '', 'Inferidos': '', 'REC_MED_IN': '', 'Reservas_M': '', 'C1_M_I': '', 'C2_M_I': '', 'C3_M_I': '', 'C1_M': '', 'C2_M': '', 'C3_M': '', 'C1_I': '', 'C2_I': '', 'C3_I': '', 'C1_Inf': '', 'C2_Inf': '', 'C3_Inf': '', 'C1_R_M_I': '', 'C2_R_M_I': '', 'C3_R_M_I': '', 'X': '', 'Y': '', 'XNORTE': '', 'YNORTE': '', 'CONON': '', 'PROVINCIA': '', 'MUNICIPIO': '', });
...
lyr_YACIMIENTOSNOMETALICOS_3.set('fieldLabels', {'idbal': 'hidden field', 'YACIMIENTO': 'inline label - always visible', 'SECTOR': 'inline label - always visible', 'TIPO': 'inline label - always visible', 'MAT_PRIMA': 'inline label - always visible', 'EMPRESA': 'inline label - always visible', 'ESTATUS': 'inline label - always visible', 'extracc': 'hidden field', 'extraccNat': 'hidden field', 'UM': 'inline label - always visible', 'umtext': 'hidden field', 'PAR_CALIDA': 'hidden field', 'parametr_1': 'hidden field', 'R_MEDIDOS': 'hidden field', 'R_INDICADO': 'hidden field', 'R_INFERIDO': 'hidden field', 'REC_MED_IN': 'inline label - always visible', 'RESERVAS': 'hidden field', 'C1_M_I': 'hidden field', 'C2_M_I': 'hidden field', 'C3_M_I': 'hidden field', 'PAR_CAL1_M': 'hidden field', 'PAR_CAL2_M': 'hidden field', 'PAR_CAL3_M': 'hidden field', 'PAR_CAL1_I': 'hidden field', 'PAR_CAL2_I': 'hidden field', 'PAR_CAL3_I': 'hidden field', 'PAR_CAL1_1': 'hidden field', 'PAR_CAL2_1': 'hidden field', 'PAR_CAL3_1': 'hidden field', 'C1_R_M_I': 'hidden field', 'C2_R_M_I': 'hidden field', 'C3_R_M_I': 'hidden field', 'X': 'hidden field', 'Y': 'hidden field', 'XNORTE': 'hidden field', 'YNORTE': 'hidden field', 'CONON': 'hidden field', 'PROVINCIA': 'inline label - always visible', 'MUNICIPIO': 'inline label - always visible', });
lyr_YACIMIENTOSMETALICOS_4.set('fieldLabels', {'idbal': 'hidden field', 'YACIMIENTO': 'inline label - always visible', 'SECTOR': 'inline label - always visible', 'TIPO': 'inline label - always visible', 'MAT_PRIMA': 'inline label - always visible', 'EMPRESA': 'inline label - always visible', 'ESTATUS': 'inline label - always visible', 'extracc': 'hidden field', 'extraccNat': 'hidden field', 'UM': 'inline label - always visible', 'umtext': 'hidden field', 'parametros': 'hidden field', 'parametr_1': 'hidden field', 'Medidos': 'hidden field', 'Indicados': 'hidden field', 'Inferidos': 'hidden field', 'REC_MED_IN': 'inline label - always visible', 'Reservas_M': 'hidden field', 'C1_M_I': 'hidden field', 'C2_M_I': 'hidden field', 'C3_M_I': 'hidden field', 'C1_M': 'hidden field', 'C2_M': 'hidden field', 'C3_M': 'hidden field', 'C1_I': 'hidden field', 'C2_I': 'hidden field', 'C3_I': 'hidden field', 'C1_Inf': 'hidden field', 'C2_Inf': 'hidden field', 'C3_Inf': 'hidden field', 'C1_R_M_I': 'hidden field', 'C2_R_M_I': 'hidden field', 'C3_R_M_I': 'hidden field', 'X': 'hidden field', 'Y': 'hidden field', 'XNORTE': 'hidden field', 'YNORTE': 'hidden field', 'CONON': 'hidden field', 'PROVINCIA': 'inline label - always visible', 'MUNICIPIO': 'inline label - always visible', });
