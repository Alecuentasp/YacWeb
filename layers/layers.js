...
//ol.proj.get("EPSG:4326").setExtent([-88.017662, 18.297801, -70.860350, 28.249688]);
var wms_layers = [];
...
lyr_AREAS_PROTEGIDAS_1.set('fieldLabels', {'ID': 'hidden field', 'NOMBRE': 'hidden field', 'CAT_MANEJO': 'hidden field', 'CAT_SIGNIF': 'hidden field', 'SUP_TIERRA': 'hidden field', 'SUP_MAR': 'hidden field', 'SUP_TOTAL': 'hidden field', 'OBJETO': 'hidden field', });
lyr_CUENCASDEINTERESNACIONAL_2.set('fieldLabels', {'id': 'hidden field', 'objectid': 'hidden field', 'nombre': 'hidden field', 'numero': 'hidden field', 'longitud': 'hidden field', 'area': 'hidden field', });
lyr_YACIMIENTOSNOMETALICOS_3.set('fieldLabels', {'idbal': 'no label', 'YACIMIENTO': 'inline label - always visible', 'SECTOR': 'inline label - always visible', 'TIPO': 'inline label - always visible', 'MAT_PRIMA': 'inline label - always visible', 'EMPRESA': 'inline label - always visible', 'ESTATUS': 'hidden field', 'extracc': 'hidden field', 'extraccNat': 'hidden field', 'UM': 'inline label - visible with data', 'umtext': 'hidden field', 'PAR_CALIDA': 'hidden field', 'parametr_1': 'hidden field', 'R_MEDIDOS': 'hidden field', 'R_INDICADO': 'hidden field', 'R_INFERIDO': 'inline label - always visible', 'REC_MED_IN': 'inline label - always visible', 'RESERVAS': 'hidden field', 'C1_M_I': 'hidden field', 'C2_M_I': 'hidden field', 'C3_M_I': 'hidden field', 'PAR_CAL1_M': 'hidden field', 'PAR_CAL2_M': 'hidden field', 'PAR_CAL3_M': 'hidden field', 'PAR_CAL1_I': 'hidden field', 'PAR_CAL2_I': 'hidden field', 'PAR_CAL3_I': 'hidden field', 'PAR_CAL1_1': 'hidden field', 'PAR_CAL2_1': 'hidden field', 'PAR_CAL3_1': 'hidden field', 'C1_R_M_I': 'hidden field', 'C2_R_M_I': 'hidden field', 'C3_R_M_I': 'hidden field', 'X': 'hidden field', 'Y': 'hidden field', 'XNORTE': 'hidden field', 'YNORTE': 'hidden field', 'CONON': 'no label', 'PROVINCIA': 'inline label - always visible', 'MUNICIPIO': 'inline label - always visible', });
lyr_YACIMIENTOSMETALICOS_4.set('fieldLabels', {'idbal': 'hidden field', 'YACIMIENTO': 'inline label - always visible', 'SECTOR': 'inline label - always visible', 'TIPO': 'inline label - always visible', 'MAT_PRIMA': 'inline label - always visible', 'EMPRESA': 'inline label - always visible', 'ESTATUS': 'hidden field', 'extracc': 'hidden field', 'extraccNat': 'hidden field', 'UM': 'hidden field', 'umtext': 'hidden field', 'parametros': 'hidden field', 'parametr_1': 'hidden field', 'Medidos': 'hidden field', 'Indicados': 'hidden field', 'R_INFERIDO': 'no label', 'R_MED_IN': 'inline label - always visible', 'Reservas_M': 'hidden field', 'C1_M_I': 'hidden field', 'C2_M_I': 'hidden field', 'C3_M_I': 'hidden field', 'C1_M': 'hidden field', 'C2_M': 'hidden field', 'C3_M': 'hidden field', 'C1_I': 'hidden field', 'C2_I': 'hidden field', 'C3_I': 'hidden field', 'C1_Inf': 'hidden field', 'C2_Inf': 'hidden field', 'C3_Inf': 'hidden field', 'C1_R_M_I': 'hidden field', 'C2_R_M_I': 'hidden field', 'C3_R_M_I': 'hidden field', 'X': 'hidden field', 'Y': 'hidden field', 'XNORTE': 'hidden field', 'YNORTE': 'hidden field', 'CONON': 'hidden field', 'PROVINCIA': 'inline label - always visible', 'MUNICIPIO': 'inline label - always visible', });
